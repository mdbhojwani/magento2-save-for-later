...
use Mdbhojwani\SaveForLater\Controller\AbstractIndex;
...
use Mdbhojwani\SaveForLater\Model\LocaleQuantityProcessor;
use Mdbhojwani\SaveForLater\Model\ResourceModel\Item\Option\Collection;

/**
 * Add SaveForLater item to shopping cart and remove from SaveForLater controller.
 */
class Cart extends AbstractIndex implements Action\HttpPostActionInterface
{
    ...
    /**
     * Add SaveForLater item to shopping cart and remove from SaveForLater
     *
     * If Product has required options - item removed from SaveForLater and redirect
