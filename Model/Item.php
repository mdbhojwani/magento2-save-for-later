...
use Mdbhojwani\SaveForLater\Model\Item\Option;
use Mdbhojwani\SaveForLater\Model\Item\OptionFactory;
use Mdbhojwani\SaveForLater\Model\ResourceModel\Item\Option\CollectionFactory;
use Magento\Catalog\Model\Product\Exception as ProductException;

/**
 * SaveForLater item model
 *
 * @method int getSaveforlaterId()
 * @method \Mdbhojwani\SaveForLater\Model\Item setSaveforlaterId(int $value)
 * @method int getProductId()
 * @method \Mdbhojwani\SaveForLater\Model\Item setProductId(int $value)
 * @method int getStoreId()
 * @method \Mdbhojwani\SaveForLater\Model\Item setStoreId(int $value)
 * @method string getAddedAt()
 * @method \Mdbhojwani\SaveForLater\Model\Item setAddedAt(string $value)
 * @method string getDescription()
 * @method \Mdbhojwani\SaveForLater\Model\Item setDescription(string $value)
...
class Item extends AbstractModel implements ItemInterface
{
     ...
     * @var string
     */
    protected $_customOptionDownloadUrl = 'saveforlater/index/downloadCustomOption';
     ...
     * @var string
     */
    protected $_eventPrefix = 'saveforlater_item';
     ...
     * @var OptionFactory
     */
    protected $_saveForLaterOptFactory;

    /**
     * @var CollectionFactory
     */
    protected $_saveForLaterOptionCollectionFactory;
     ...
     * @param OptionFactory $saveForLaterOptFactory
     * @param CollectionFactory $saveForLaterOptionCollectionFactory
    ...
    public function __construct(
        ...
        OptionFactory $saveForLaterOptFactory,
        CollectionFactory $saveForLaterOptionCollectionFactory,
        ...
        $this->_saveForLaterOptFactory = $saveForLaterOptFactory;
        $this->_saveForLaterOptionCollectionFactory = $saveForLaterOptionCollectionFactory;
    ...
    {
        $this->_init(\Mdbhojwani\SaveForLater\Model\ResourceModel\Item::class);
    }
    ...
    /**
     * Validate SaveForLater item data
     *
     * @return bool
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    ...
    {
        if (!$this->getSaveforlaterId()) {
            throw new \Magento\Framework\Exception\LocalizedException(__('We can\'t specify a Save For Later.'));
        }
    ...
    /**
     * Load item by product, SaveForLater and shared stores
     *
     ...
     * @return $this
     */
    public function loadByProductSaveForLater($saveForLaterId, $productId, $sharedStores)
    {
        $this->_getResource()->loadByProductSaveForLater($this, $saveForLaterId, $productId, $sharedStores);
        $this->_afterLoad();
        $this->setOrigData();
    ...
    {
        if (is_array($option)) {
            $option = $this->_saveForLaterOptFactory->create()->setData($option)->setItem($this);
        } elseif ($option instanceof Option) {
            $option->setItem($this);
        } elseif ($option instanceof \Magento\Framework\DataObject) {
            $option = $this->_saveForLaterOptFactory->create()->setData($option->getData())
    ...
    public function loadWithOptions($id, $optionsFilter = null)
    {
        ...
        $options = $this->_saveForLaterOptionCollectionFactory->create()->addItemFilter($this);
        if ($optionsFilter) {
