...
namespace Mdbhojwani\SaveForLater\Model\Item;
    ...
    \Magento\Catalog\Model\Product\Configuration\Item\Option\OptionInterface
{
    ...
    {
        $this->_init(\Mdbhojwani\SaveForLater\Model\ResourceModel\Item\Option::class);
    }
    ...
    {
        $this->setSaveforlaterItemId($item->getId());
        $this->_item = $item;
        return $this;
    }
    ...
    {
        if ($this->getItem()) {
            $this->setSaveforlaterItemId($this->getItem()->getId());
        }
